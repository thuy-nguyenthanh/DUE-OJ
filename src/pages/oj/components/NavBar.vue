<template>
  <div id="header">
    <Menu theme="light" mode="horizontal" @on-select="handleRoute" :active-name="activeMenu" :class="oj-menu">
      ...
      <div class="logo" title="HocTrucTuyen123.NET"><a href="/"><img src="/static/img/logo.png" height="60px" alt="Học Trực Tuyến 123.NET - Học lập trình tương tác trực tuyến"></a></div>
    ...
    methods: {
      ...
      handleRoute (route) {
        if (route && route.indexOf('blog') >= 0) {
          window.open('https://hoctructuyen123.net', '_blank')
